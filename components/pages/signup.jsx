...
export default function SignupPage({ onSignup, setCurrentPage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Account created successfully! Welcome to Evallo.");
      onSignup();
    } catch (error) {
      ...
      } else if (error.message !== "Registration failed. Please try again.") {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-purple-50 to-pink-100 dark:from-gray-900 dark:to-gray-800 px-4 py-8">
      {/* Background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-96 h-96 bg-purple-200 dark:bg-purple-900 rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <div
          className="absolute bottom-20 left-10 w-96 h-96 bg-pink-200 dark:bg-pink-900 rounded-full blur-3xl opacity-20 animate-pulse"
